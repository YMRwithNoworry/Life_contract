...
public class DataGogglesItem extends ArmorItem {
    
    public DataGogglesItem(ArmorMaterial material, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        tooltipComponents.add(Component.literal("§b数据终端套装 - 头部").withStyle(ChatFormatting.AQUA));
        tooltipComponents.add(Component.literal(""));
