...
public class TerminalRobeItem extends ArmorItem {
    
    public TerminalRobeItem(ArmorMaterial material, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        tooltipComponents.add(Component.literal("§b数据终端套装 - 胸甲").withStyle(ChatFormatting.AQUA));
        tooltipComponents.add(Component.literal(""));
