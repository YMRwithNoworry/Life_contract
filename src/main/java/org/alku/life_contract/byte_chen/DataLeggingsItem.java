...
public class DataLeggingsItem extends ArmorItem {
    
    public DataLeggingsItem(ArmorMaterial material, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        ...
        tooltipComponents.add(Component.literal("§b数据终端套装 - 护腿").withStyle(ChatFormatting.AQUA));
        tooltipComponents.add(Component.literal(""));
